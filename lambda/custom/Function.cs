...
namespace songQuiz
{
    public class Function
    {
        ...
        const string WELCOME_MESSAGE = "Welcome to the Song Writer Quiz Game!  You can ask me about any song and its writer, or you can ask me to start a quiz.  What would you like to do?";
        
        //This is the message a user will hear when they try to cancel or stop the skill, or when they finish a quiz.
        const string EXIT_SKILL_MESSAGE = "Thank you for playing the Song Writer Quiz Game!  Let's play again soon!";

        //This is the message a user will hear after they ask (and hear) about a specific data element.
        const string REPROMPT_SPEECH = "Which other song or writer would you like to know about?";

        //This is the message a user will hear when they ask Alexa for help in your skill.
        const string HELP_MESSAGE = "I know lots of things about songs.  You can ask me about a song or a writer, and I'll tell you what I know.  You can also test your knowledge by asking me to start a quiz.  What would you like to do?";
        ...
        {
            return item.SongName + " is written by " + item.SongWriter + sayas + ".  I've added " + item.SongName 
                + " to your Alexa app.  Which other song or writer would you like to know about?";
        }

        /// <summary>
        /// Returns a descriptive sentence about your data. Before a user starts a quiz, they can ask about
        /// a specific data element,like "Hey Jude."  The skill will speak the sentence from this function, 
        /// pulling the data values from the appropriate record in your data.
        /// </summary>
        /// <param name="item"></param>
        /// <returns>string</returns>
        ...
        {
            //   return item.SongName + " is written by " + item.SongWriter + " + sayas + ". Which other song or writer would you like to know about?";

            return item.SongName + " is wtitten by " + item.SongWriter + ". Which other song or writer would you like to know about?";
        ...
        {
            return "Here is your " + counter.ToString() + "th question.  What is the " + property + " of " + item.SongName + "?";
            /*
            switch(property)
            {
                case "Album":
                    return "Here is your " + counter + "th question.  What album is " + item.SongName + " from?";
                break;
                case "Genre":
                    return "Here is your " + counter + "th question.  What genre do the " + item.SongWriter + " " + item.Mascot + " play?";
                break;
                default:
                    return "Here is your " + counter + "th question.  What is the " + property + " of the "  + item.Album + "?";
                break;
            }
            */
        }
